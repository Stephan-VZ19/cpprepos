...
public:
	...
	/// <summary>
	/// Returns buffer capacity. The bufer capacity cannot be smaller than ShortCapacity.
	/// </summary>
	size_t capacity() const noexcept;
	
	/// <summary>
	/// Returns substring of range [beg, end).
	...
	/// <summary>
	/// Returns immutable zero-terminated C-String.
	/// </summary>
	...
	/// <summary>
	/// Returns reference to character at position i.
	/// Can return reference to zero-termination (the behavior is undefined if this character 
	...
	std::strong_ordering operator<=>(const String& s) const noexcept;
	...
	bool operator==(const String& s) const noexcept { return *this <=> s == 0; }
